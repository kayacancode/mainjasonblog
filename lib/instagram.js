...
import { getSupabaseUrl, getSupabaseServiceKey, getFacebookAppId, getFacebookAppSecret, getFacebookPageToken } from './env';
...
export async function getBusinessAccount(pageAccessToken) {
    ...
    const token = pageAccessToken || getFacebookPageToken();
