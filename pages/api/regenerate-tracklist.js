...
async function generateTracklistImage(tracks, weekStart) {
    ...
    // Use Liberation Sans which we've included in the fonts directory
    // This font will be bundled with the serverless function
    const svg = `<?xml version="1.0" encoding="UTF-8"?>
    <svg width="${CANVAS_WIDTH}" height="${CANVAS_HEIGHT}" viewBox="0 0 ${CANVAS_WIDTH} ${CANVAS_HEIGHT}" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <style type="text/css">
                <![CDATA[
                    .title { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-weight: bold; font-size: 52px; fill: ${TEXT_WHITE}; }
                    .subtitle { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-size: 30px; fill: ${TEXT_WHITE}; }
                    .track-number { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-weight: bold; font-size: 36px; fill: ${TEXT_GRAY}; }
                    .track-title { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-weight: bold; font-size: 36px; fill: ${TEXT_WHITE}; }
                    .track-artist { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-size: 26px; fill: ${TEXT_GRAY}; }
                    .footer { font-family: 'Liberation Sans', 'DejaVu Sans', sans-serif; font-size: 28px; fill: ${TEXT_GRAY}; }
                ]]>
            </style>
        </defs>
