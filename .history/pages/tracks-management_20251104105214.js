    ...
    const handleSaveSettings = async () => {
        ...
        try {
            ...
            if (selectedCoverTrack) {
                ...
                // Set the processed custom image URL (only if column exists)
                if (customImageUrl) {
                ...
                // Only try to clear custom_image_url if column exists
                // (Supabase will ignore fields that don't exist in schema)
            }
            ...
            alert('Settings saved successfully! The cover image has been processed with branding overlay. The next time images are generated, they will use this processed image.');
