    ...
    <div className=" font-Archivo bg-black h-[100%] ">
      ...
      <div className="   text-white pt-10">
        ...
        >
            ...
            <div className=" text-center ">
              ...
              <div className="mb-4">
                ...
                <div className="rounded">
                  ...
                  <textarea
                    ...
                    className="resize-none bg-transparent   p-4 outline-none max-h-80 h-25 w-full sm:w-96 border-2 rounded"
              ...
              <div className="p-10 sm:p-20  block  rounded mt-2 border-2 ">
                <div className="text-center block">
                  ...
                  <input
                    type="file"
                    className=" text-white p-4 w-full lg: w-[200px] sm:w-[263px]  border-2 rounded my-2 text-center"
          ...
          <button
            type="submit"
            className=" border-4 hover:bg-black hover:text-white rounded-full py-2 px-8 "
            >
            {loading
