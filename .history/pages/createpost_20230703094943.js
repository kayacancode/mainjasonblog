...
<div className="min-h-screen  items-center justify-center bg-[#303030]">
      ...
      <div className="text-[#F2EA6D] mx-10">
        ...
        <form onSubmit={(e) => createPost(e)}>
          ...
          <div className="rounded bg-transparent  w-9/12 border-2 border-[#f2ea6d]">
            <textarea
              onChange={(event) => {
                setPostText(event.target.value);
              }}
              class="resize-none text-[#000] p-4 outline-none max-h-80	h-80 w-full border-b-2 border-[#f2ea6d] rounded"
