        ...
        >
          <div className="block md:flex">
            <div className=" text-center ">
              <h1 className="	 text-gray font-Archio mb-10  	 text-5xl	 py-2 	">
              ...
              <h2 className="text-xl text-gray font-bold pt-8">
                Upload file
              </h2>
              <h2 className="text-base sm:text-lg text-gray pt-2">
              ...
              <div className="p-10 sm:p-20 bg-[#e7f0fe] block  rounded mt-2  ">
                <div className="text-center block">
                  ...
                  <input
                    type="file"
                    className="bg-[#A3CBD4] text-gray p-4 w-full lg: w-[200px] sm:w-[263px] rounded my-2 text-center"
          ...
          <div className="mt-10">
            ...
            <div className="m-5 p-3 bg-[#f6f9fc] rounded shadow-lg ">
              ...
              <div className="p-5 text-center">
                <a href="#">
                  <h5 className="mb-2 text-lg  font-bold tracking-tight text-gray">
                    Blog Title
                  </h5>
