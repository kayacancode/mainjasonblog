  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      ...
      {isAdmin && (
        <div className="bg-[#F2EA6D] text-black px-4 py-2 text-center font-medium">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span>Admin Mode - You can delete photos (Debug: isAdmin={isAdmin.toString()})</span>
          </div>
        </div>
      )}
      ...
      <div className="bg-gray-800 text-white p-2 text-sm">
        Debug: User signed in: {user ? 'Yes' : 'No'} | Is Admin: {isAdmin ? 'Yes' : 'No'} | User email: {user?.email || 'None'}
      </div>
