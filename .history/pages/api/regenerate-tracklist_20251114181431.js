...
`;
        ...
        try {
            ...
            if (!pythonProcess) {
                throw new Error(`Python not found. Tried: ${pythonCommands.join(', ')}. ${spawnError?.message || 'Python runtime may not be available in this serverless environment. Consider using a Node.js image generation library or a separate Python serverless function.'}`);
            }
