        ...
        try {
            ...
            for (const pythonCmd of pythonCommands) {
                try {
                    ...
                    // If spawn succeeded, break out of loop
                    break;
                } catch (err) {
                    pythonError = err;
                    continue;
            ...
            if (!pythonProcess) {
                throw new Error(`Python not found. Tried: ${pythonCommands.join(', ')}. ${pythonError?.message || 'Python runtime may not be available in this environment.'}`);
            }
