...
class SpotifyNewMusicAutomation:
    ...
    def create_single_artist_image(self, track: Dict, spotify_client, output_filename: str = "nmf_single_artist.png") -> str:
        ...
        try:
            ...
            # Larger/bolder sizes
            title_font = load_font_prefer_helvetica(190, condensed=False)   # top artist name
            name_font = load_font_prefer_helvetica(92, condensed=False)     # bottom-left lines
            stacked_font_big = load_font_prefer_helvetica(150, condensed=True)   # NEW
            stacked_font_small = load_font_prefer_helvetica(135, condensed=True) # MUSIC/FRIDAY
