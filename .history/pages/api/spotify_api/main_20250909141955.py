    ...
    def create_single_artist_image(self, track: Dict, spotify_client, output_filename: str = "nmf_single_artist.png") -> str:
        ...
        try:
            ...
            def load_font_prefer_helvetica(size: int, condensed: bool = False):
                ...
                index_order = [6, 7, 5, 4, 3, 2, 1, 0] if condensed else [2, 3, 4, 5, 1, 0]
            ...
            # Larger/bolder sizes
            title_font = load_font_prefer_helvetica(170, condensed=False)   # top artist name
            name_font = load_font_prefer_helvetica(92, condensed=False)     # bottom-left lines
            stacked_font_big = load_font_prefer_helvetica(150, condensed=False)   # NEW - bold not condensed
            stacked_font_small = load_font_prefer_helvetica(135, condensed=False) # MUSIC/FRIDAY - bold not condensed
