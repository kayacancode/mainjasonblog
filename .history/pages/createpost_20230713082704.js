...
const Createpost = () => {
  ...
  const handlePost = (e) => {
    ...
    createPost(e); // Call the createPost function for posting
  };
  ...
  const updatePost = async () => {
    ...
    try {
      ...
      if (imgUpload) {
        ...
        url = existingImageUrl; // Use the existing image URL if it was not changed
      }
  
      await updateDoc(doc(db, "posts", router.query.postId), {
        title,
        postText,
        imgUrl: url || "",
      });
