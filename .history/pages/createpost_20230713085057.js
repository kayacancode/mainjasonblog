            ...
            <div className=" text-center ">
              ...
              <div className="mb-4">
                ...
                <div className="rounded">
                  ...
                  <textarea
                    ...
                    className="resize-none bg-transparent   p-4 outline-none max-h-80 h-25 w-full sm:w-96 border-b-2 rounded"
              ...
              <div className="p-10 sm:p-20 bg-[#e7f0fe] block  rounded mt-2  ">
                <div className="text-center block">
                  ...
                  <input
                    type="file"
                    className="bg-[#A3CBD4] text-white p-4 w-full lg: w-[200px] sm:w-[263px] rounded my-2 text-center"
