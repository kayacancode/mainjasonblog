          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-lg border border-gray-200/50 p-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                  ...
                  <div key={post.id} className="bg-white rounded-2xl shadow-md hover:shadow-xl border border-gray-200/50 overflow-hidden transform hover:scale-105 transition-all duration-300">
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <span className="text-xs bg-orange-500 text-white px-3 py-1 rounded-full font-semibold whitespace-nowrap ml-2">
                          Scheduled
                        </span>
                      </div>
          ...
          <div className="bg-gray-50/80 rounded-2xl p-6 mb-8 border border-gray-200/50">
            ...
            <form onSubmit={handlePhotoUpload} className="space-y-6">
              ...
              <button
                ...
                className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-8 py-3 rounded-2xl transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {uploading ? (
                  <span className="flex items-center space-x-2">
